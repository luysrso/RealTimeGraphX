...
namespace RealTimeGraphX.UWP
{
    ...
    public class BuffUwpGraphSurface : Control, IGraphSurface<UwpGraphDataSeries>
    {
        ...
        public List<System.Drawing.PointF> cibf;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BuffUwpGraphSurface"/> class.
        /// </summary>
        public BuffUwpGraphSurface()
        {
        ...
        public async void DrawSeries(UwpGraphDataSeries dataSeries, IEnumerable<System.Drawing.PointF> points)
        {
            ...
            if (cibf != null)
            {
                ...
                if (cibf.Count() > 1) _session.DrawPolyline(cibf.Select(x => new Vector2(x.X, x.Y)).ToList(),
